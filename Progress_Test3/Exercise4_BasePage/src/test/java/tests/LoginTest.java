...
public class LoginTest extends BaseTest {
    ...
    static void initPage() {
        // driver is created in BaseTest.setUpBase()
    ...
    void testLoginSuccess() {
        ...
        WebElement successMsg = wait
                .until(ExpectedConditions.visibilityOfElementLocated(loginPage.getSuccessLocator()));
    ...
    void testLoginWithMultipleParameters(String username, String password, String expectedResult) {
        ...
        By messageLocator = expectedResult.equals("success") ? loginPage.getSuccessLocator()
        ...
        if (expectedResult.equals("success")) {
            ...
            assertTrue(message.getText().toLowerCase().contains("invalid")
                    || message.getText().toLowerCase().contains("error"));
        }
    }
    ...
    static void tearDown() {
        // driver quit is handled in BaseTest. No action needed here.
    }
}
